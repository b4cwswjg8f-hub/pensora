  ...
  <div class="vscr">
    ...
    <section class="hero">
      <div class="hero-content">
        ...
        <h1 class="hero-title">
          Build wealth.<br/><span class="hero-accent">In your new home and beyond.</span>
        </h1>
        <p class="hero-lead">
    ...
    <section class="trust-section">
      <div class="trust-inner">
        <div class="ey-pill mb-4">Why Thrive Abroad</div>
        <div class="trust-grid">
          {#each [
            { num: '100 %', label: 'Runs in Your Browser', sub: 'No data sent anywhere' },
            { num: '0',     label: 'Login Required',       sub: 'Start instantly' },
            { num: 'DE',    label: 'German Tax Law',       sub: '§ 64 SGB VI · § 10 EStG' },
            { num: '5',     label: 'Calculators',          sub: 'Free forever' },
          ] as item}
    ...
    <section class="cta-strip">
      <div class="cta-inner">
        ...
        <p class="cta-sub">30 minutes, free. Niall Bradfield walks through your numbers and what to do next.</p>
